...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_firejob:getOtherPlayerData', function(playerData)
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(0, 167) and not isDead and ESX.PlayerData.job and ESX.PlayerData.job.name == 'fire' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'fire_actions') then
			if not Config.EnableESXService then
